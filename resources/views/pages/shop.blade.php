            ...
            <div class="col-lg-6">
                ...
                <div class="row my-5">
                    ...
                    $images = [
                        ...
                        asset('images/support.svg'),
                        asset('images/return.svg'),
                    ];
                    ?>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="feature">
                            <div class="icon">
                                <img src="{{ $image }}" alt="Image" class="imf-fluid">
                            </div>
        ...
        <div class="row justify-content-between">
            <div class="col-lg-7 mb-5 mb-lg-0">
                <div class="imgs-grid">
                    ...
                    ?>
                    @foreach($imageGrid as $image)
                    <div class="grid grid-1"><img src="{{ $image }}" alt="Untree.co"></div>
                    @endforeach
                </div>
            </div>
